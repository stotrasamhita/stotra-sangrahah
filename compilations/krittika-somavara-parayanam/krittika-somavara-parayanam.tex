...
\usepackage[paperwidth=144mm,paperheight=192mm,left=4mm,right=4mm,top=9mm,bottom=9mm]{geometry}
...
\begin{titlepage}
    \vspace*{5cm}
    \begin{center}
        {\font\x="Sanskrit 2003:script=deva,mapping=tex-text" at 48pt \x कृत्तिका-सोमवासर-पारायणम्}
    \end{center}
\end{titlepage}
